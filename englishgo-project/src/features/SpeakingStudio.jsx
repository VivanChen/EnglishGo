...
export default function SpeakingStudio({ lv, onBack, onXp, apiKey, onOpenSettings, deps }) {
  ...
  const explain = async () => {
    ...
    } catch { if (token === request.current) setAiError('這次的分析暫時沒有回來，先用下面的發音提示練習。'); }
