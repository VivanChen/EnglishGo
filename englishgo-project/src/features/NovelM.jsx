...
export default function NovelM({lv,onBack,onXp,deps}){
  ...
  const mobileReaderHeight=readingFocus?(mobileToolsOpen?"clamp(480px, calc(100svh - 320px), 660px)":"clamp(540px, calc(100svh - 210px), 780px)"):"clamp(430px, calc(100svh - 320px), 620px)";
