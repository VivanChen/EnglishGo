...
export default function NovelM({lv,onBack,onXp,deps}){
  ...
  const pageSheetStyle=(item,start=pageNow)=>({height:"100%",minWidth:0,overflow:"hidden",display:"flex",flexDirection:"column",background:"#FFFDF7",border:`1px solid ${S.bd}`,borderRadius:isMobile?8:item.index===start?"8px 2px 2px 8px":"2px 8px 8px 2px",padding:isMobile?"14px 12px 12px":"16px 14px 12px",boxShadow:item.index===start?"inset -14px 0 24px rgba(80,55,24,.05),0 10px 24px rgba(64,43,20,.1)":"inset 14px 0 24px rgba(80,55,24,.05),0 10px 24px rgba(64,43,20,.1)"});
