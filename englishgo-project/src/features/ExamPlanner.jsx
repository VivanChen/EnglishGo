...
export default function ExamPlanner({ lv, onBack, onStart, apiKey, onOpenSettings, deps }) {
  ...
  const generate = async () => {
    ...
    catch { if (token === aiRequest.current) setAiError('AI 建議暫時沒有回來，你原本的範圍仍然保留著。'); }
