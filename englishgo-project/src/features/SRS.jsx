...
function VocabularyTopicPicker({lv,levelPools,poolSources,weakWords,onLevelChange,onBack,onStart,LV,S,Hdr}){
  const c=LV[lv];
  ...
  return(<div className="srs-topic-page" style={{"--topic-accent":c.cl,"--topic-accent-2":c.ac,"--topic-soft":c.bg,"--topic-card":S.bg1,"--topic-surface":S.bg2,"--topic-border":S.bd,"--topic-text":S.t1,"--topic-muted":S.t2,"--topic-faint":S.t3}}>
    ...
    <div className="srs-topic-summary">
      <div className="srs-topic-summary-head"><b>{c.ic} {c.l}目前可練字庫</b><span>{levelCards.length} 個不重複單字 · {poolSources?.[lv]==="hybrid"?"雲端＋本機已去重":"本機備援"}</span></div>
    ...
    <style>{`
      ...
      .srs-topic-summary-head{display:flex;justify-content:space-between;gap:10px;align-items:center;font-size:13px}.srs-topic-summary-head span{font-size:12px;color:var(--topic-faint)}
      ...
      @media(max-width:620px){.srs-topic-hero{padding:14px;align-items:flex-start}.srs-topic-hero-icon{font-size:34px}.srs-topic-hero h2{font-size:17px}.srs-grade-tabs button{min-height:66px;flex-direction:column;justify-content:center;gap:3px;padding:7px 4px}.srs-grade-tabs button span{font-size:13px}.srs-topic-grid{grid-template-columns:1fr}.srs-topic-card{min-height:104px}.srs-topic-summary-head{align-items:flex-start;flex-direction:column;gap:3px}.srs-topic-focus{align-items:stretch;flex-direction:column}.srs-topic-focus button{width:100%;min-height:44px}}
    `}</style>
  </div>);
}
