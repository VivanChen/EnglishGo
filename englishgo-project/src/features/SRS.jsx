...
function VocabularyTopicPicker({lv,levelPools,poolSources,weakWords,onBack,onStart,LV,S,Hdr}){
  ...
  return(<div className="srs-topic-page" style={{"--topic-accent":c.cl,"--topic-accent-2":c.ac,"--topic-soft":c.bg,"--topic-card":S.bg1,"--topic-surface":S.bg2,"--topic-border":S.bd,"--topic-text":S.t1,"--topic-muted":S.t2,"--topic-faint":S.t3}}>
    ...
    <section className="srs-topic-hero">
      ...
      <div><h2>{c.ic} {c.l}主題複習</h2><p>選擇今天想練的主題，每輪最多 {VOCABULARY_TOPIC_TARGET} 張。若要更換年級，請返回外層重新選擇。</p></div>
    </section>
    ...
    <style>{`
      ...
      @media(max-width:620px){.srs-topic-hero{padding:14px;align-items:flex-start}.srs-topic-hero-icon{font-size:34px}.srs-topic-hero h2{font-size:17px}.srs-topic-grid{grid-template-columns:1fr}.srs-topic-card{min-height:104px}.srs-topic-summary-head{align-items:flex-start;flex-direction:column;gap:3px}.srs-topic-focus{align-items:stretch;flex-direction:column}.srs-topic-focus button{width:100%;min-height:44px}}
    `}</style>
  </div>);
}
