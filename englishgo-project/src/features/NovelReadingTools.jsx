export function NovelJourney({ novel, chapterNo, completed, progress, bookmarks, onJump, onRemove }) {
  return <div className="novel-journey">
    <p className="novel-tool-hint">調整字體或螢幕大小，也能接著原本的段落讀。書籤保存在這個瀏覽器。</p>
    ...
    </li>)}</ul> : <div className="novel-bookmark-empty"><span aria-hidden="true">♧</span><strong>把喜歡的段落留下來</strong><p>點段落旁的書籤，就能從這裡回去重讀。</p></div>}
