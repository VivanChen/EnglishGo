export default function PracticeArt({ kind = 'quiz', complete = false }) {
  return <svg className="practice-art" viewBox="0 0 380 250" aria-hidden="true">
    ...
    {kind === 'explore' ? <g stroke="#507364" strokeWidth="5" strokeLinejoin="round"><rect x="79" y="87" width="140" height="120" rx="15" fill="#fffdf3" transform="rotate(-8 149 147)"/><path d="M101 122l76-10m-73 33l43-5m-39 29l72-10"/><circle cx="229" cy="109" r="47" fill="#dbe8ef" fillOpacity=".9"/><path d="M263 144l41 43" strokeWidth="17" strokeLinecap="round"/><path d="M207 112l13 13 28-32" stroke="#79a3b1" fill="none" strokeWidth="7"/></g> : kind === 'tutor' ? <g stroke="#507364" strokeWidth="5" strokeLinejoin="round"><path d="M70 72h185a18 18 0 0118 18v63a18 18 0 01-18 18h-91l-31 25 3-25H70a18 18 0 01-18-18V90a18 18 0 0118-18Z" fill="#fffdf3"/><path d="M85 105h127m-127 27h74"/><rect x="199" y="138" width="108" height="69" rx="20" fill="#dbe8ef"/><circle cx="227" cy="166" r="3" fill="#507364"/><circle cx="277" cy="166" r="3" fill="#507364"/><path d="M238 183q14 14 28-1" fill="none"/></g> : kind === 'listening' ? <g stroke="#507364" strokeWidth="6" strokeLinejoin="round">
